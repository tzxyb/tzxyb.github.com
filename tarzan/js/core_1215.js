...
ucar.uitls = {
        ...
        if (!$("#dialog-mask").length) {
            ...
            switch(type){
                case 'normal':
                    ...
                    break;
                case 'big':
                     $(dialog).html("<div class='dialog'><div class='dialog-content'><p>" + msg + "</p><span class='btn-dialog-close'></span></div></div>");
                    break;
            };
    ...
    loading: {
        show: function() {
            var html = "<div id='loading-mask' class='mask'><div class='loading-full'><img src='http://mktimage.10101111cdn.com/wap/2015/download/app/loading_new.gif' /><div></div></div></div>";
