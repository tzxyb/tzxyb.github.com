...
SliderUnlock.prototype.handerIn = function () {
    ...
    _self.min = 0;
    _self.max = _self.elm.width()*heit;
}
...
SliderUnlock.prototype.reset = function () {
    ...
    _self.index = 0;
	$('.p1_sk_con').animate({width: (_self.index/heit)}, _self.opts.duration) 
	
    _self.elm.find(".slideunlock-label").animate({left: (_self.index/heit)}, _self.opts.duration)
...
SliderUnlock.prototype.backgroundTranslate = function () {
    var _self = this;
	$('.p1_sk_con').css('width',(_self.index/heit) + "px");
...
SliderUnlock.prototype.updateView = function () {
  var _self = this;
    ...
    if (_self.index == (_self.max - 0)) {
        ...
        _self.elm.addClass("success").find(".slideunlock-lable-tip").css(style);
    } else {
